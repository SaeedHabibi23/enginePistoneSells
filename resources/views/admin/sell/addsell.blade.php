...
<form method="post" action="savesell">
    @csrf
   ...
   <div class="col-lg-6">
         مقدار اول 
        <input type="number" id="name"   name="ProductcountOne" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول دو 
   ...
   <div class="col-lg-6">
         مقدار دوم 
        <input type="number" id="name"   name="Productcounttwo" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول سه 
   ...
   <div class="col-lg-6">
         مقدار سوم 
        <input type="number" id="name"   name="Productcountthree" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول چهار 
   ...
   <div class="col-lg-6">
         مقدار چهارم 
        <input type="number" id="name"   name="Productcountfour" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول پنج 
   ...
   <div class="col-lg-6">
         مقدار پنجم 
        <input type="number" id="name"   name="Productcountfive" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول شش 
   ...
   <div class="col-lg-6">
         مقدار ششم 
        <input type="number" id="name"   name="Productcountsex" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول هفت 
   ...
   <div class="col-lg-6">
         مقدار هفتم 
        <input type="number" id="name"   name="Productcountseven" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول هشت 
   ...
   <div class="col-lg-6">
         مقدار هشتم 
        <input type="number" id="name"   name="Productcounteight" class="form-control">
    </div>
   <div class="col-lg-6">
   محصول نه 
   ...
   <div class="col-lg-6">
         مقدار نهم 
        <input type="number" id="name"   name="Productcountnine" class="form-control">
    </div>
   ...
   <div class="col-lg-6">
         مقدار دهم 
        <input type="number" id="name"   name="Productcountten" class="form-control">
    </div>

 
    <div class="col-lg-6">
    نوعیت فروش 
    <select name="selltype" id="selltype" class="form-control">
